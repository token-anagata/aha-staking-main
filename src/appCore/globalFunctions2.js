...
export const chainName = {
              ...
              web3 = new Web3(Web3.givenProvider || 'https://polygon-rpc.com/'); // YOU MUST BE ON THE POLYGON MAINNET ON METAMASK
              // web3 = new Web3(Web3.givenProvider || 'https://rpc-mumbai.maticvigil.com/');
...
export const getConnectedWalletBalance = async () => {
  try {
    const connectedWallet = await getConnectedWalletAddress(),
          ...
          walletBalance = await contractInfo.methods.balanceOf(connectedWallet).call()
...
export const connectToMetamask = async () => {
  ...
  if (connectedAccount && connectedAccount.length > 0) { // METAMASK IS ALREADY CONNECTED
